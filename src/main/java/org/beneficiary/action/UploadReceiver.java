package org.beneficiary.action;
...
{
    private static final File UPLOAD_DIR = new File("/home/ndikraxx/IdeaProjects/furahia/src/main/webapp/benImage");
    private static final File TEMP_DIR = new File("/home/ndikraxx/IdeaProjects/furahia/src/main/webapp/benImage/temp");
    ...
    {
        File dir = new File(String.valueOf(UPLOAD_DIR));
        dir.mkdirs();
        if (requestParser.getPartIndex() >= 0)
        {
